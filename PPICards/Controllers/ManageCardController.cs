...
namespace PPICards.Controllers
{
    ...
    public class ManageCardController : Controller
    {
        ...
        public IActionResult BlockCard()
        {
            return View();
        }
        ...
        public IActionResult ReplacementCard()
        {
            return View();
        }
        ...
        public JsonResult CustomerWallet(string amount, string kitRefNo)
        {
            ...
            try
            {
                if (string.IsNullOrEmpty(amount) && string.IsNullOrEmpty(kitRefNo))
                {
                    return Json(1);
                }
